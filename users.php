                ...
                function listaUsuarios($conexao)
                {
                    ...
                    while($array=mysqli_fetch_assoc($resultado)) { global $id; $id = $array['cod_usuario']?>
                        <tr>
                            ...
                            <td align='center'><a href="apaga_usuario.php?codigo=<?php echo $id;?>"onclick="return confirm('Deseja realmente excluir o esse usuário?')"><img src="img/lixeira.png" width="25px" height="25px"></a></td>
                        </tr>
                        <?php
                    }
                }
